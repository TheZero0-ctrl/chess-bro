...
export default class extends Controller {
  ...
  static values = { gameId: Number, playerId: Number, fen: String, turn: String, orientation: String }
  connect() {
    this.play()
    this.sub = this.cable()
    this.gameOver();
  ...
  play() {
    ...
    this.pgn_pre_tag = document.getElementById("pre_pgn_game_" + this.gameIdValue);
    this.pgn = this.pgn_pre_tag.textContent;
    this.game.loadPgn(this.pgn);
    this.whiteSquareGrey = "#a9a9a9";
    this.blackSquareGrey = "#696969";
    this.player = this.orientationValue[0];
